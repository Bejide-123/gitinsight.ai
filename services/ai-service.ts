...
README SUMMARY:
${input.readme ? input.readme.slice(0, 1500) : "No README found"}
...
{
  "executiveSummary": "3-4 sentence plain English summary of what this project is, its engineering maturity, and its biggest opportunity. Be specific to this repo, not generic.",
